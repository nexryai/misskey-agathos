...
describe("users/notes", () => {
    ...
    before(async () => {
        ...
        const jpg = await uploadUrl(alice, "https://raw.githubusercontent.com/nexryai/nexkey/nightly/packages/backend/test/resources/Lenna.jpg");
        const png = await uploadUrl(alice, "https://raw.githubusercontent.com/nexryai/nexkey/nightly/packages/backend/test/resources/Lenna.png");
