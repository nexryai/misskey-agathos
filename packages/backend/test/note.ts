...
describe("Note", () => {
    ...
    it("ファイルを添付できる", async(async () => {
        const file = await uploadUrl(alice, "https://raw.githubusercontent.com/nexryai/nexkey/nightly/packages/backend/test/resources/Lenna.jpg");
    ...
    it("他人のファイルは無視", async(async () => {
        const file = await uploadUrl(bob, "https://raw.githubusercontent.com/nexryai/nexkey/nightly/packages/backend/test/resources/Lenna.jpg");
